...
public class SudokuBoard extends DrawableElement {
    ...
    /**
     * Checks if array contains numbers from 1 to the number of elements in the array
     *
     * @param check integer array to test
     * @return whether the array contains all numbers in increments of 1
     */
